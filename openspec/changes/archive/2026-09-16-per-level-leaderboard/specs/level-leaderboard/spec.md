...
Each entry on the per-level leaderboard SHALL display the player's rank number, username, profile ball, rank badge, star rating, move count, and elapsed time.

#### Scenario: Entry contents

- **WHEN** a player views the level 10 leaderboard
